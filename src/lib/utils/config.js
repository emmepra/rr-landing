// global parameter exporter for the whole proj

// CONTENT CONFIG

export const dataPaths = {
    groups: 'src/lib/assets/data/groups.json'
}
...
export const scatterColors = {
	...
	quintiles: [emptyDot, 'black', 'yellow', 'green', 'blue', 'green'],
	quintiles2: [emptyDot, 'black', 'yellow', 'green', 'blue', 'green'],
};
